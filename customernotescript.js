const API_URL = "https://oncall-e3it.azurewebsites.net/api/customer_note_added_tickets";

async function fetchCustomerNoteAddedTickets() {
    try {
...
function displayTickets(tickets) {
    ...
    if (tickets.length === 0) {
        ticketContainer.innerHTML = `<p>No customer note added tickets at the moment. 🎉</p>`;
        return;
    }
...
fetchCustomerNoteAddedTickets();
setInterval(fetchCustomerNoteAddedTickets, 60000);
